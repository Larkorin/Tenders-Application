function CreatedBillsView() {

    this.ViewName = "CreatedBillsView";
    ...
    this.ObtenerFacturas = () => {
        ...
        controlActions.GetToApiV2(this.ApiService + "RetriveByUserInCharge?userId=" + localStorage.getItem("idUsuario"), (data) => {

            this.facturas = data;

            $("#viewCreatedBills").empty();
